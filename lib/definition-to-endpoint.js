...
function findBreakingChanges({ method, url, definition }) {
  ...
  if (route === "GET /repos/{owner}/{repo}/actions/permissions") {
    changes.push({
      type: "OPERATION",
      date: "2020-11-10",
      note: `"actions/getRepoPermissions" operation ID is now "actions/getGithubActionsPermissionsRepository"`,
      before: {
        operationId: "actions/getRepoPermissions",
      },
      after: {
        operationId: "actions/getGithubActionsPermissionsRepository",
      },
    });
  }
